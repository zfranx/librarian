...
<head>
	<meta charset="UTF-8">
	<title>Fasilkom Online Library</title>
...
<body>
		...
		<div class="reg-wrapper">
			...
			<div class="reg-body">
				...
				<?php endif ?>
                    ...
                    <div class="form-group">
                    	 <label for="session">School Year <span>*</span></label>
                        <input type="text" class="form-control custom" placeholder="2023/2024" name="session"/>
                    </div>
                    <div class="form-group">
                    	 <label for="regno">NIM <span>*</span></label>
                        <input type="text" class="form-control custom" placeholder="NIM" name="regno"/>
                    </div>
    ...
    <div class="footer text-center">
        <p>&copy; All rights reserved ingpo loker</p>
    </div>
